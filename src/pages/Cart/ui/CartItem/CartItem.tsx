...
//actions
import { productCartAction } from '@/entities/products/model/slice/productCartSlice';
//selectors
...
export const CartItem: FC<CartItemProps> = ({
  ...
  const productsCart = useSelector(getProductsCartState);
  ...
  const updateProductsCart = (updateCount: number) => {
    ...
    dispatch(productCartAction.updateProductsCart(newProductsCart));
  };
